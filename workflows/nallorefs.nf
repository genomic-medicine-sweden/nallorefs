...
workflow NALLOREFS {
    ...
    ch_strdrop_training_set_json = downloadChannelOf(params.base_reference_dir + 'nallo/annotation/grch38_strdrop_training_set' + params.strdrop_training_set_version + '.json')
